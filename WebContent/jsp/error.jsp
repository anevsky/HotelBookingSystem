...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>
            <fmt:message bundle="${messages}" key="error.title" />
            -            
        ...
        <div id="content">
            ...
            <div id="container">
                ...
                <div id="right-sidebar">
                    ...
                    <h2><fmt:message bundle="${messages}" key="error.title" /></h2>
                    <div class="text">
                        <c:choose>
                            <c:when test="${errorMessage != null}">
                                <fmt:message bundle="${messages}" key="${errorMessage}" />
                            </c:when>
                            <c:otherwise>
                                <fmt:message bundle="${messages}" key="error.unknown.message" />
                            </c:otherwise>
                        </c:choose>
                    </div>
